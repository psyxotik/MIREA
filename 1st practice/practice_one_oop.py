...
эти языки содержат переменные и операторы присваивания
"""
print('№1')
print('Ответ: C++, Java, Python, Go; в этих языках программа состоит из последовательных команд, которые изменяют состояние программы\
в них важно описать каждый алгоритм для достижения цели\n')
"""
...
class Cat(Animal):
    ...
    def print(self):
        print('Подкласс кошка, наследованный от класса животное')
        super().print() # Вызов метода print() базового класса

# Дочерний класс Dog
class Dog(Animal):
    def __init__(self, name, weight):
        print('Подкласс собака, наследованный от класса животное')
...
print('№4 Python\nОтвет:')
print('Класс кошелёк')
print('монеты в кошелке:', wallet.coins, 'В кошелёк было добавлено три монеты номиналом 5 едениц и одна монета номиналом 10 едениц')
